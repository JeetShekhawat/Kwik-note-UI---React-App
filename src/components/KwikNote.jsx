  ...
  return (
    <>
    {
        isEditing ? (
            ...
            <textarea value={newText} onChange={(e) => setNewText(e.target.value)} className="bg-yellow-50"> </textarea>
            <br />
            <button onClick={handleSave} className="text-white text-sm bg-lime-700 hover:bg-lime-800 py-1 px-3 dark:bg-lime-600 dark:hover:bg-lime-700 rounded-lg mt-6 ">
              Save
            </button>
          </div>

        ) : (
            <div className= "bg-yellow-100 p-2 rounded-md shadow-lg shadow-slate-300 m-6">
